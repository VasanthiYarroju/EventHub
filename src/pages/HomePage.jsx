        ...
        <section id="testimonials" className="section-padding testimonials-section">
            <div className="container">
                ...
                <div className="grid-container grid-cols-lg-3 grid-cols-md-2" style={{gap: '2.5rem'}}>
                    <div className="testimonial-card" data-aos="fade-up" data-aos-delay="100"><div className="testimonial-header"><div className="testimonial-quote-icon"><i className="fas fa-quote-left"></i></div><div className="testimonial-stars"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></div></div><p className="testimonial-text">“EventHub transformed our wedding into the magical day we had always dreamed of...”</p><div className="testimonial-author"><img src="/images/c1.jpg" alt="Client" /><div><h4>Jennifer & Michael</h4><p>Wedding Clients</p></div></div></div>
                    <div className="testimonial-card" data-aos="fade-up" data-aos-delay="200"><div className="testimonial-header"><div className="testimonial-quote-icon"><i className="fas fa-quote-left"></i></div><div className="testimonial-stars"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></div></div><p className="testimonial-text">“Our corporate retreat was flawlessly executed thanks to EventHub...”</p><div className="testimonial-author"><img src="/images/b1.jpg" alt="Client" /><div><h4>Robert Johnson</h4><p>CEO, TechInnovate</p></div></div></div>
                    <div className="testimonial-card" data-aos="fade-up" data-aos-delay="300"><div className="testimonial-header"><div className="testimonial-quote-icon"><i className="fas fa-quote-left"></i></div><div className="testimonial-stars"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></div></div><p className="testimonial-text">“The 50th birthday party exceeded all expectations...”</p><div className="testimonial-author"><img src="/images/f1.jpg" alt="Client" /><div><h4>Samantha Williams</h4><p>Birthday Celebration</p></div></div></div>
                </div>
          ...
          <div className="container">
            ...
            <div className="team-slider-container">
              <div className="team-slider-images" ref={teamSliderRef}>
                <div className="team-slider-img"><img src="/images/w1.jpg" alt="Team Member Mike" /><h1>Mike</h1><div className="team-details"><h2>Mike Johnson</h2><p>Creative Director</p><p>With 15+ years of experience, Mike leads our creative team with innovative concepts.</p></div></div>
                <div className="team-slider-img"><img src="/images/c1.jpg" alt="Team Member Samite" /><h1>Samite</h1><div className="team-details"><h2>Samantha Lee</h2><p>Event Coordinator</p><p>Samantha's attention to detail ensures every aspect of your event runs smoothly.</p></div></div>
                <div className="team-slider-img"><img src="/images/b1.jpg" alt="Team Member Hashi" /><h1>Hashi</h1><div className="team-details"><h2>Hashim Ahmed</h2><p>Technical Director</p><p>Hashim's expertise in audio-visual production creates the perfect ambiance.</p></div></div>
                <div className="team-slider-img active"><img src="/images/f1.jpg" alt="Team Member Kaity" /><h1>Kaity</h1><div className="team-details"><h2>Kaitlyn Taylor</h2><p>Lead Planner</p><p>Kaitlyn's creativity and organization skills make her the perfect person to transform your vision.</p></div></div>
                <div className="team-slider-img"><img src="/images/w1.jpg" alt="Team Member Lauren" /><h1>Lauren</h1><div className="team-details"><h2>Lauren Garcia</h2><p>Decor Specialist</p><p>Lauren's eye for design and aesthetics ensures your event space looks stunning.</p></div></div>
                <div className="team-slider-img"><img src="/images/c1.jpg" alt="Team Member Ryan" /><h1>Ryan</h1><div className="team-details"><h2>Ryan Wilson</h2><p>Logistics Manager</p><p>Ryan handles all the behind-the-scenes logistics to ensure your event runs flawlessly.</p></div></div>
                <div className="team-slider-img"><img src="/images/b1.jpg" alt="Team Member Daniel" /><h1>Daniel</h1><div className="team-details"><h2>Daniel Kim</h2><p>Catering Director</p><p>Daniel works with top chefs to create custom menus that delight your guests.</p></div></div>
              </div>
            </div>
          </div>
        </section>
